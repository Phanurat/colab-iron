...
func extractPostIDpreC0mment2_FetchPredictiveTextSuggestions(rawurl string) (string, error) {
...
func generateFeedbackIDpreC0mment2_FetchPredictiveTextSuggestions(postID string) string {
	return base64.StdEncoding.EncodeToString([]byte("feedback:" + postID))
}

func randomExcellentBandwidthpreC0mment2_FetchPredictiveTextSuggestions() string {
...
func generateUUIDpreC0mment2_FetchPredictiveTextSuggestions() string {
	return uuid.New().String()
}

func generateHex32preC0mment2_FetchPredictiveTextSuggestions() string {
	return strings.ReplaceAll(uuid.New().String(), "-", "")
}

// connToken := generateHex32()

func RunpreC0mment2_FetchPredictiveTextSuggestions(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	connToken := generateHex32preC0mment2_FetchPredictiveTextSuggestions()
	...
	postID, err := extractPostIDpreC0mment2_FetchPredictiveTextSuggestions(link)
	if err != nil {
		fmt.Println("❌ ขุด postID ล้มเหลว: " + err.Error())
		return
	}
	feedbackID := generateFeedbackIDpreC0mment2_FetchPredictiveTextSuggestions(postID)
	traceID := generateUUIDpreC0mment2_FetchPredictiveTextSuggestions()
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthpreC0mment2_FetchPredictiveTextSuggestions())
