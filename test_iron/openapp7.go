...
// --------------------- CONFIG ---------------------
var (
	hostopenapp7 = "graph.facebook.com"

	//	deviceGroup  = "6301"
	friendlyNameopenapp7 = "FxFBMasterAccountQuery"
	clientDocIDopenapp7  = "33066571502608096553904710747"
	privacyCtxopenapp7   = "1085642755668917"
)

// --------------------------------------------------

func randomExcellentBandwidthopenapp7() string {
...
func Runopenapp7(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", friendlyNameopenapp7)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDopenapp7)
	form.Set("variables", `{}`)
	...
	req, _ := http.NewRequest("POST", "https://"+hostopenapp7+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostopenapp7)
	...
	req.Header.Set("X-FB-Friendly-Name", friendlyNameopenapp7)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxopenapp7)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthopenapp7()) //เพิ่มเข้าไป
