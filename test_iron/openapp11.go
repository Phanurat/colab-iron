...
var (
	//	deviceGroup  = "6301"
	hostopenapp11         = "graph.facebook.com"
	friendlyNameopenapp11 = "SearchResultsExploreWatch"
	clientDocIDopenapp11  = "22179742109882060373014436"
	privacyCtxopenapp11   = "504658830243196"
)

func randomExcellentBandwidthopenapp11() string {
...
func Runopenapp11(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", friendlyNameopenapp11)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDopenapp11)
	form.Set("variables", `{"typeahead_sid":"abcd"}`)
	...
	req, _ := http.NewRequest("POST", "https://"+hostopenapp11+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostopenapp11)
	req.Header.Set("Transfer-Encoding", "chunked")
	req.Header.Set("X-FB-Background-State", "1")
	req.Header.Set("x-fb-client-ip", "True")
	// req.Header.Set("X-FB-Connection-Type", "WIFI")
	req.Header.Set("x-fb-device-group", devicegroup)
	req.Header.Set("X-FB-Friendly-Name", friendlyNameopenapp11)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxopenapp11)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthopenapp11()) //เพิ่มเข้าไป
