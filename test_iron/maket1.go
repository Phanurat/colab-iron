...
func randomExcellentBandwidthmaket1() string {
...
func Runmaket1(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	variables := map[string]interface{}{
		...
		"marketplaceID":                             nil,
		"predictedTTRC":                             nil,
		"prefetchConfidence":                        nil,
		"scale":                                     2.625,
		"sessionID":                                 nil,
		"topOfFeedFetchReason":                      nil,
		"radius":                                    nil,
		"shippedOnly":                               nil,
	}
	...
	form.Set("fb_api_req_friendly_name", "MarketplacePlainHomeAppQuery")
	form.Set("variables", string(varBuf))
	form.Set("server_timestamps", "true")
	form.Set("doc_id", "5296392397151061")
	...
	req.Header.Set("X-FB-Friendly-Name", "RelayFBNetwork_MarketplacePlainHomeAppQuery")
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthmaket1())
