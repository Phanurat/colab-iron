...
// ================= CONFIG ====================
var (
	hostfetch_feed1 = "graph.facebook.com"
)

// =============================================

func randomExcellentBandwidthfetch_feed1() string {
...
func Runfetch_feed1(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", "fresh_feed_new_data_fetch")
	...
	req, _ := http.NewRequest("POST", "https://"+hostfetch_feed1+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostfetch_feed1)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthfetch_feed1())
