...
// --------------- CONFIG -----------------
var (
	hostopenapp8 = "graph.facebook.com"

	deviceGroupopenapp8  = "6301"
	friendlyNameopenapp8 = "IABAutofillNegativeInteractionQuery"
	clientDocIDopenapp8  = "2145706637242268580545750364"
	privacyCtxopenapp8   = "c000000000000000"
)

// ----------------------------------------

func randomExcellentBandwidthopenapp8() string {
...
func Runopenapp8(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", friendlyNameopenapp8)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDopenapp8)
	form.Set("variables", `{"params":{}}`)
	...
	req, _ := http.NewRequest("POST", "https://"+hostopenapp8+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostopenapp8)
	req.Header.Set("Transfer-Encoding", "chunked")
	req.Header.Set("X-FB-Background-State", "1")
	req.Header.Set("x-fb-client-ip", "True")
	// req.Header.Set("X-FB-Connection-Type", "WIFI")
	req.Header.Set("X-FB-Connection-Type", "MOBILE.HSDPA")
	req.Header.Set("x-fb-device-group", deviceGroupopenapp8)
	req.Header.Set("X-FB-Friendly-Name", friendlyNameopenapp8)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxopenapp8)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthopenapp8()) //เพิ่มเข้าไป
