...
func randomExcellentBandwidthmaket4() string {
...
func Runmaket4(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", "MarketplaceNuxStoreNuxStatesQuery")
	form.Set("variables", string(varBuf))
	form.Set("server_timestamps", "true")
	form.Set("doc_id", "5909574675817876")
	...
	req.Header.Set("X-FB-Friendly-Name", "RelayFBNetwork_MarketplaceNuxStoreNuxStatesQuery")
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthmaket4())
...
func prettyPrintJSONmaket4(input []byte) string {
