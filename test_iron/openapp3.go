...
var (
	...
	hostopenapp3         = "graph.facebook.com"
	friendlyNameopenapp3 = "SOAPSeenPostCreationQuery"
	clientDocIDopenapp3  = "106240174218259292654863584760"
	privacyCtxopenapp3   = "329983911584722"
)

// ------------------------------
func randomExcellentBandwidthopenapp3() string {
...
func Runopenapp3(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", friendlyNameopenapp3)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDopenapp3)
	form.Set("variables", `{}`)
	...
	req, _ := http.NewRequest("POST", "https://"+hostopenapp3+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostopenapp3)
	...
	req.Header.Set("X-FB-Friendly-Name", friendlyNameopenapp3)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxopenapp3)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthopenapp3()) //เพิ่มเข้าไป
