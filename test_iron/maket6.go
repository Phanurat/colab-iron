...
func randomExcellentBandwidthmaket6() string {
...
func Runmaket6(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", "MarketplaceShopPromotionMessageQuery")
	form.Set("variables", string(varBuf))
	form.Set("server_timestamps", "true")
	form.Set("doc_id", "3949647725136661")
	...
	req.Header.Set("X-FB-Friendly-Name", "RelayFBNetwork_MarketplaceShopPromotionMessageQuery")
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthmaket6())
...
func prettyPrintJSONmaket6(input []byte) string {
