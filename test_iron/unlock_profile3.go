...
func randomExcellentBandwidthunlock_profile3() string {
...
// ------------------------------
var (
	hostunlock_profile3                 = "graph.facebook.com"
	friendlyNameunlock_profile3         = "NativeTemplateAsyncQuery"
	clientDocIDunlock_profile3          = "30749539925783572052554034822"
	privacyMutationTokenunlock_profile3 = "eyJ0eXBlIjo1LCJjcmVhdGlvbl90aW1lIjoxNzQ5MjI2OTE5fQ%253D%253D" // <<< แก้เองตามที่ดักมา
)

// ------------------------------

func Rununlock_profile3(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	fmt.Println("🌐 ใช้ Proxy:", proxyAddr) // ✅ เพิ่ม debug แสดง proxy ที่ใช้อยู่
	connToken := generateHex32unlock_profile3()
	...
	form.Set("fb_api_req_friendly_name", friendlyNameunlock_profile3)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDunlock_profile3)
	form.Set("variables", variables)
	form.Set("fb_api_analytics_tags", `["GraphServices"]`)
	form.Set("client_trace_id", traceID)

	req, _ := http.NewRequest("POST", "https://"+hostunlock_profile3+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "zstd, gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostunlock_profile3)
	...
	req.Header.Set("X-FB-Friendly-Name", friendlyNameunlock_profile3)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthunlock_profile3()) //เพิ่มเข้าไป
...
func generateHex32unlock_profile3() string {
