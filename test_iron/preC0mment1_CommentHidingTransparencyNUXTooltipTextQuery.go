...
func generateFeedbackIDpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(postID string) string {
	feedbackID := "feedback:" + postID
	return base64.StdEncoding.EncodeToString([]byte(feedbackID))
}

func extractPostIDpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(rawurl string) (string, error) {
	var postID string
...
func isNumericpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(s string) bool {
	for _, r := range s {
		if r < '0' || r > '9' {
			return false
		}
...
func randomExcellentBandwidthpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery() string {
...
func RunpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	postID, err := extractPostIDpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(link)
	if err != nil || postID == "" {
	...
	feedbackID := generateFeedbackIDpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery(postID)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthpreC0mment1_CommentHidingTransparencyNUXTooltipTextQuery()) //เพิ่มเข้าไป
