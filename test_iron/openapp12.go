...
var (
	//	deviceGroup  = "6301"
	hostopenapp12         = "graph.facebook.com"
	friendlyNameopenapp12 = "WemPrivateSharingQuery"
	clientDocIDopenapp12  = "51657574914655283094089725770"
	privacyCtxopenapp12   = "1752774255071641"
)

func randomExcellentBandwidthopenapp12() string {
...
func Runopenapp12(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", friendlyNameopenapp12)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDopenapp12)
	form.Set("variables", `{}`)
	...
	req, _ := http.NewRequest("POST", "https://"+hostopenapp12+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostopenapp12)
	...
	req.Header.Set("X-FB-Friendly-Name", friendlyNameopenapp12)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxopenapp12)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthopenapp12()) //เพิ่มเข้าไป
