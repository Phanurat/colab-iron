...
func randomExcellentBandwidthmaket2() string {
...
func Runmaket2(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	...
	form.Set("fb_api_req_friendly_name", "MarketplaceNotificationsMicrotraySurfaceQuery")
	form.Set("variables", string(varBuf))
	form.Set("server_timestamps", "true")
	form.Set("doc_id", "6939145059477296")
	...
	req.Header.Set("X-FB-Friendly-Name", "RelayFBNetwork_MarketplaceNotificationsMicrotraySurfaceQuery")
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthmaket2())
