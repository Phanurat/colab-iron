...
func randomExcellentBandwidthlock_profile5() string {
...
// ============== แก้ไขค่าได้แค่ตรงนี้ ==============
var (
	hostlock_profile5         = "graph.facebook.com"
	friendlyNamelock_profile5 = "WemPrivateSharingHomeQuery"
	clientDocIDlock_profile5  = "75545763910014367436364274671"
	privacyCtxlock_profile5   = "1752774255071641"
)

// ====================================================

func Runlock_profile5(tlsConns *TLSConnections, proxyAddr, proxyAuth string) {
	fmt.Println("🌐 ใช้ Proxy:", proxyAddr) // ✅ เพิ่ม debug แสดง proxy ที่ใช้อยู่
	connToken := generateHex32lock_profile5()
	sessionID := fmt.Sprintf("nid=TSRsHSL+wunc;tid=208;nc=0;fc=0;bc=0;cid=%s", connToken)
	...
	form.Set("fb_api_req_friendly_name", friendlyNamelock_profile5)
	form.Set("fb_api_caller_class", "graphservice")
	form.Set("client_doc_id", clientDocIDlock_profile5)
	form.Set("variables", variables)
	form.Set("fb_api_analytics_tags", `["GraphServices"]`)
	form.Set("client_trace_id", traceID)

	req, _ := http.NewRequest("POST", "https://"+hostlock_profile5+"/graphql", bytes.NewBufferString(form.Encode()))
	req.Header.Set("Authorization", "OAuth "+accessToken)
	req.Header.Set("Content-Type", "application/x-www-form-urlencoded")
	req.Header.Set("User-Agent", userAgent)
	req.Header.Set("Accept-Encoding", "zstd, gzip, deflate")
	req.Header.Set("Connection", "keep-alive")
	req.Header.Set("Host", hostlock_profile5)
	...
	req.Header.Set("X-FB-Friendly-Name", friendlyNamelock_profile5)
	req.Header.Set("X-FB-HTTP-Engine", "Liger")
	req.Header.Set("x-fb-privacy-context", privacyCtxlock_profile5)
	...
	req.Header.Set("x-fb-connection-bandwidth", randomExcellentBandwidthlock_profile5()) //เพิ่มเข้าไป
...
func generateHex32lock_profile5() string {
